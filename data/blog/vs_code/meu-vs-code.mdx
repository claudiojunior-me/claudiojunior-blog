...
tags: ['vs code']
draft: false
summary: Algumas configurações e extensões que eu considero essenciais sempre que vou utilizar meu VS Code
images: []
layout: PostLayout
authors: ['default']
---
...
<img src="/static/images/posts/vs_code/cover.jpg" width="100%" height="250" style="object-fit: cover;" />
