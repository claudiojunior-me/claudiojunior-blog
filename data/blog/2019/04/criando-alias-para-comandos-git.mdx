---
title: Criando alias para comandos Git
date: '2019-04-10'
tags: ['git']
draft: false
summary: Uma forma de atribuir um comando complexo a um comando mais simples e personalizado.
images: []
layout: PostLayout
authors: ['default']
---
...
![Photo by Stefan Steinbauer on Unsplash](/static/images/posts/saga_git/stefan-steinbauer-452213-unsplash.jpg)
